                                ...
                                <div class="quick_activity_wrap">
                                    ...
                                    <div class="single_quick_activity">
                                        ...
                                        <div id="bar2" class="barfiller">
                                            ...
                                            <span class="fill" data-percentage="{{$total_orders == 0 ? 0 : number_format(($pending_orders/$total_orders)*100)}}"></span>
                                        </div>
                                    </div>
                                    <!-- single_quick_activity  -->
                                    <div class="single_quick_activity">
                                    ...
                                    <div class="single_quick_activity">
                                        ...
                                        <div id="bar4" class="barfiller">
                                            ...
                                            <span class="fill" data-percentage="{{$total_users == 0 ? 0 : number_format(($active_users/$total_users)*100)}}"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
